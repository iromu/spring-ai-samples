 ...
 *
 * This record encapsulates a collection of tags, where each tag provides
 * metadata associated with a specific model. It provides a structured way
 * to retrieve and manage the tags for models in the system.
 *
 * Fields:
 *
