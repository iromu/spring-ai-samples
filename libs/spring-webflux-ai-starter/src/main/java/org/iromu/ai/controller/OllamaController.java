...
/**
 * Interface OllamaController represents a REST controller defining endpoints
 * for various operations related to chat models, versioning, and tag management.
 * It acts as a contract for implementing controllers that interact with model-based
 * chat services.
 *
 ...
 *
 * Annotations:
 * - @RestController defines this class as a RESTful controller component.
...
public interface OllamaController {
     ...
     *
     * @return a {@code Mono<TagsResponse>} containing a list of model tags wrapped in a reactive stream.
     */
    @GetMapping("/tags")
     ...
     *
     * @return a {@code Mono<VersionResponse>} containing the version information wrapped in a reactive stream.
     */
    @GetMapping("/version")
    ...
    /**
     * Handles chat requests by processing the provided chat data and returning a stream of chat responses.
     *
     * @param request the {@code ChatRequest} containing the input model, messages, stream configuration,
     *                system context, and additional options for the chat interaction.
     * @return a {@code Flux<ChatStreamResponse>} that streams the response messages from the chat interaction.
     */
     ...
     *
     * @param request the {@code ModelActionRequest} containing details such as the model name
     *                and associated parameters required for the delete operation.
     * @return a {@code Mono<Map<String, String>>} signaling the result of the operation.
     *         By default, this method returns an error indicating that the endpoint is not implemented.
     */
     ...
     *
     * @param request the {@code ModelActionRequest} containing details such as the model name
     *                and associated parameters required for the pull operation.
     * @return a {@code Flux<ActionResponse>} that streams the status and progress of the pull operation.
     *         By default, this method returns an error indicating that the endpoint is not implemented.
     */
    @PostMapping("/pull")
     ...
     *
     * @param request the {@code ModelActionRequest} containing details such as the model name
     *                and associated parameters required for the push operation.
     * @return a {@code Flux<ActionResponse>} that streams the status and progress of the push operation.
     *         By default, this method returns an error indicating that the endpoint is not implemented.
     */
    @PostMapping("/push")
     ...
     * @return a {@code Mono<ModelShowResponse>} containing the model details wrapped in a reactive stream
     */
    @GetMapping("/show")
