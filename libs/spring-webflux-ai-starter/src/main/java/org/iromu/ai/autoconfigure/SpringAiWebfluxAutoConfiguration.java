...
public class SpringAiWebfluxAutoConfiguration {
	 ...
	 * {@code DefaultOllamaController} class to wire dependencies and configure default
	 * behavior.
	 * @param buildProperties optional build properties providing metadata about the
	 * application's build.
	 * @param appName the name of the application, typically retrieved from the
	 * {@code spring.application.name} property.
	 * @param model the default model to be used for chat interactions, retrieved from the
	 * {@code spring.ai.ollama.chat.options.model} property.
	 * @param ollamaService the service implementation for handling chat-based operations,
	 * responsible for processing and streaming responses.
	 * @return an instance of {@code DefaultOllamaController} configured with the provided
	 * dependencies.
	 */
	@Bean
